...
$mail->Host = 'mail.carringtoncondo.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@carringtoncondo.ca'; // SMTP username
$mail->Password = 'carringtoncondo'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@carringtoncondo.ca', $_POST['name']);
...
$mail->Subject = "Carrington Condo Calgary - Landing Page Inquiry";
$message = '<html>
