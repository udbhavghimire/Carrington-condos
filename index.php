...
<head>
    ...
    <meta name="Author" content="Carrington Condos" />
    <!-- Bootstrap CSS -->
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "Carrington Condos",
            "url": "https://carringtoncondo.ca/"
        }
    </script>
</head>
...
<body>
                    ...
                    <div class="col-12 d-flex justify-content-start justify-content-md-end">
                        <ul class="navbar-nav mb-2 mb-lg-0 align-items-start align-items-md-center">
                            ...
                            <li class="nav-item px-md-2">
                                <a class="nav-link scrollto" href="#builder">Builder</a>
                            </li>
                            <!-- <li class="nav-item px-md-2">
    ...
    <section>
        <div class="container pt-3 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="200">
            ...
            <div class="pt-md-5 pt-5" data-aos="fade-up">
                <h1 class=" main-titlee  pb-4 ps-3 ps-md-0 d-flex justify-content-center brand-color center-sm">
                   Carrington Condo Calgary
                </h1>
                <p class="textt justify-content-center brand-color center-sm text-center pb-2 fs-4 px-2 ">
                    <span>
                    Carrington Condos in Calgary is a brand New Pre-construction condo development by Truman Homes, Located at North West Calgary in Calgary.
                    </span> </p>
            </div>
            <div class="d-flex justify-content-center text-center textt  fs-4 px-1">
                <div class="list d-block ">
                    ...
                    <p class="mybot pb-md-0 pb-0 ">
                        <span class="fw-bold">Project Type:</span> Condominiums
                    </p>
                    <p class="mybot pb-md-0 pb-0 ">
                        <span class="fw-bold">Address:</span> North West Calgary, Calgary
                    </p>
                

                    <p class="mybot pb-md-0 pb-0 ">
                        <span class="fw-bold"> Pricing: </span> Not Available
                    </p>
                    <p class="mybot pb-md-0 pb-0 ">
                        <span class="fw-bold"> Number of Units:</span> 420
                    </p>
                   
                    <p class="mybot pb-md-0 pb-0 ">
                        <span class="fw-bold"> Expected Completion: </span> Q2 2024
                    </p>
  ...
  <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color">
                ...
                <span class=" pt-2 small-text text-center d-flex justify-content-center align-items-center custom-underline pb-3 textt fs-4 px-2 ">Truman Homes is Calgary's Leading New Homes Development Company. Truman is Award-winning master builder serving Calgary & area for over 35 years. For more than three and a half decades, Truman Homes has established itself as a shining example of excellence and unwavering commitment within the construction industry. Their reputation isn't limited to mere words; it's substantiated by numerous accomplishments that underscore their steadfast dedication to their craft and their customers. Truman Homes' Commitment to Quality A Legacy of Acknowledgment Truman's remarkable expertise in constructing homes has not escaped recognition.</span>
  </div>
    </section>
    ...
    <section>
        <div class="container pt-md-5 pt-sm-2">
            ...
            <div class="py-5" id="location">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color">
                    <span class="mx-1">Carrington Condos - Location </span>
                </h2>
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">Northwest Calgary, AB</span>
                <div>
                    <div class="bg-white p-1   rounded-mine d-flex justify-content-center">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d160296.83345661673!2d-114.33171220052482!3d51.11513842733855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537168d45bdbb7bd%3A0x97850dd7002facb0!2sNorthwest%20Calgary%2C%20Calgary%2C%20AB%2C%20Canada!5e0!3m2!1sen!2snp!4v1709283634285!5m2!1sen!2snp" width="90%" height="550" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            ...
            <div class="pt-5 mt-5">
                <div class="row mx-0 ">
                    ...
                    <div class="registertext px-4 d-flex justify-content-center align-items-center  text-center">
                        <p>Register today to get the more information on Carrington Condos coming up in Calgary
                        </p>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-3 mx-0 g-5 pb-md-5">
                    ...
                    <div class="col-md-6 px-md-5">
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row">
                                <p class="text-muted sm-text text-center mt-0">*I consent to receive future communications about Carrington Condos. I understand I can opt out at anytime by sending an email.</p>
                            </div>
                            <div class="row">
        ...
        <div class="container ">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                <div class="col-md-5 my-3  center-sm px-4 px-md-0">
                    <p class=" ">
                    <h1 class="navbar-brand-foot fs-4 "><a href="https://dolphy.ca/pre-construction-homes/calgary/carrington-condos" target="_blank" class="text-dark text-decoration-none">Carrington Condos</a></h1>
                    </p>
                ...
                <div class="col-md-5 py-md-5 py-5 center-sm px-md-5 px-5 ">
                    <div>
                        <h5 class="text-dark fw-bold mt-3 mb-3 ">About Carrington Condos</h5>
                        <div class="list d-block ">
                            <p class="mybot pb-md-0 pb-0 ">
